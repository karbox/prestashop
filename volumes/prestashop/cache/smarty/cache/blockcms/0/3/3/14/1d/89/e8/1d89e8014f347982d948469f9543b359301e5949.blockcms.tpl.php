...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a251a970dc418_36333631',
  'has_nocache_code' => true,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a251a970dc418_36333631')) {function content_5a251a970dc418_36333631($_smarty_tpl) {?>
	<!-- Block CMS module -->
			<section id="informations_block_left_1" class="block informations_block_left">
			<p class="title_block">
				<a href="http://localhost:8080/content/category/1-glowna">
					Informacja				</a>
			</p>
			<div class="block_content list-block">
				<ul>
																							<li>
								<a href="http://localhost:8080/content/1-dostawa" title="Dostawa">
									Dostawa
								</a>
							</li>
																								<li>
								<a href="http://localhost:8080/content/2-nota-prawna" title="Nota prawna">
									Nota prawna
								</a>
							</li>
																								<li>
								...
								<a href="http://localhost:8080/content/4-o-nas" title="O nas">
									O nas
																								...
																								<li>
								<a href="http://localhost:8080/content/5-bezpieczna-platnosc" title="Bezpieczna płatność">
									Bezpieczna płatność
								</a>
							</li>
																						<li>
